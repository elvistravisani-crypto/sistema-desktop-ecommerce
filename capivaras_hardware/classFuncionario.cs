...
namespace capivaras_hardware
{
    class classFuncionario
    {
        ...
        public int CadastrarFuncionario()
        {
            ...
            string sql = $"INSERT INTO funcionario VALUES(0, {codigo_cargo}, '{nome}', '{nome_social}','{foto}', '{data_nascimento.ToString("yyyy-MM-dd")}', '{sexo}',  '{estado_civil}', '{cpf}','{rg}', '{salario.ToString().Replace(",", ".")}', '{endereco}', {numero}, '{complemento}', '{bairro}', '{cidade}', '{estado}', '{cep}', '{telefone_residencial}', '{telefone_celular}', '{email}', '{usuario}', '{senha}', {tipo_acesso}, {status}, 1, NOW() );   ";
